...
class CartController extends Controller
{
    ...
    #[OA\Get(
        ...
        description: 'Returns cart for logged-in user or guest (based on session)',
        security: [['bearerAuth' => []]],
        parameters: [
            new OA\Parameter(
                name: 'X-Session-Id',
    ...
    #[OA\Post(
        ...
        description: 'Add a product variant to cart. If already exists, increases quantity.',
        parameters: [
            new OA\Parameter(
                name: 'X-Session-Id',
                in: 'header',
    ...
    {
        try {
            // ✅ چک کن این آیتم مال این کاربر هست
    ...
    #[OA\Post(
        ...
        description: 'Called after user login to merge their guest cart with their user cart',
        security: [['bearerAuth' => []]],
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
