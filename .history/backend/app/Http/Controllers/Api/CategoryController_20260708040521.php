    ...
    public function menu()
{
    ...
    // بارگذاری بازگشتی همه زیردسته‌ها
    $this->loadChildrenRecursive($categories);
...
private function loadChildrenRecursive($categories)
{
    foreach ($categories as $category) {
        ...
        // اگر فرزندان وجود دارن، بازگشتی ادامه بده
        if ($category->children && $category->children->isNotEmpty()) {
            $this->loadChildrenRecursive($category->children);
        }
    }
}
