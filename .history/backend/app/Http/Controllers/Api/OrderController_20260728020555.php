...
use App\Http\Controllers\Api\DeliveryCalculator;
...
class OrderController extends Controller
{
    ...
    #[OA\Get(
        path: '/api/delivery/options',
        tags: ['Orders'],
        summary: 'Get delivery date and time slot options',
        description: 'Returns available dates (7 days) and time slots for delivery',
        security: [['bearerAuth' => []]],
        responses: [
