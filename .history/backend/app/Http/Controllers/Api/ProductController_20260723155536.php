    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(
                name: 'use_cursor',
                in: 'query',
                description: 'Use infinite scroll (cursor-based pagination)',
                schema: new OA\Schema(type: 'boolean', example: true)
            ),
            new OA\Parameter(
                name: 'cursor',
                in: 'query',
                description: 'Cursor for next page (get from meta.next_cursor)',
                schema: new OA\Schema(type: 'string')
            ),
            new OA\Parameter(
                name: 'limit',
                in: 'query',
                description: 'Items per scroll (default: 20, max: 50)',
