...
class OrderCreationService
{
    ...
    private const DEFAULT_SHIPPING_COST = 50000;
    ...
    public function createFromCart(
        ...
        return DB::transaction(function () use (
            $cart, $user, $address, $paymentMethod, $customerNote
        ) {
            ...
            // 2️⃣ کپی آیتم‌ها با snapshot کامل
            $this->createOrderItems($order, $cart);
            
            // 3️⃣ کاهش موجودی محصولات
            $this->reduceStock($cart);
            
            // 4️⃣ مصرف تخفیف‌ها و کوپن
            $this->consumeDiscounts($cart, $user);
            
            // 5️⃣ ثبت اولین رکورد تاریخچه
    ...
    private function createOrder(
        ...
        $totalAmount = ($subtotal - $productsDiscount - $couponDiscount) + $shippingCost;
