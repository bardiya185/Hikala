...
class AttributeSeeder extends Seeder
{
    public function run()
    {
        $this->command->info('🚀 Creating attributes and values for all categories...');

        // ================================================================
        // 1. CREATE ATTRIBUTES (ویژگی‌ها)
        // ================================================================
        $attributes = [
            // ===== General Attributes (ویژگی‌های عمومی) =====
            ...
            // ===== Mobile Attributes (ویژگی‌های موبایل) =====
            ...
            // ===== Laptop Attributes (ویژگی‌های لپ‌تاپ) =====
            ...
            // ===== Digital Products Attributes (ویژگی‌های کالای دیجیتال) =====
            ...
            // ===== Home & Kitchen Attributes (ویژگی‌های خانه و آشپزخانه) =====
            ...
            // ===== Fashion Attributes (ویژگی‌های مد و پوشاک) =====
            ...
            // ===== Jewelry Attributes (ویژگی‌های طلا و نقره) =====
            ...
            // ===== Vehicles Attributes (ویژگی‌های خودرو) =====
            ...
            // ===== Tools Attributes (ویژگی‌های ابزارآلات) =====
            ...
            // ===== Books Attributes (ویژگی‌های کتاب) =====
            ...
            // ===== Sports Attributes (ویژگی‌های ورزشی) =====
            ['name' => 'Sport Type', 'slug' => 'sport-type', 'type' => 'select', 'unit' => null, 'is_filterable' => 1, 'is_variant' => 0, 'sort_order' => 100],
            ['name' => 'Gender', 'slug' => 'gender', 'type' => 'select', 'unit' => null, 'is_filterable' => 1, 'is_variant' => 0, 'sort_order' => 101],
        ...
        // ================================================================
        // 2. CREATE ATTRIBUTE VALUES (مقادیر ویژگی‌ها)
        // ================================================================
        $attributeValues = [
            // ===== Color =====
            'color' => [
            ...
            'display-size' => [
                ...
                ['value' => '13.3 inch', 'slug' => '13-3-inch', 'color_code' => null],
                ['value' => '14 inch', 'slug' => '14-inch', 'color_code' => null],
                ['value' => '15.6 inch', 'slug' => '15-6-inch', 'color_code' => null],
                ['value' => '16 inch', 'slug' => '16-inch', 'color_code' => null],
                ['value' => '17.3 inch', 'slug' => '17-3-inch', 'color_code' => null],
            ],
            ...
            // ===== Water Resistant =====
            'water-resistant' => [
                ['value' => 'Yes', 'slug' => 'yes', 'color_code' => null],
                ['value' => 'No', 'slug' => 'no', 'color_code' => null],
            ...
            // ===== Screen Size (Laptop) =====
            'screen-size' => [
                ['value' => '11 inch', 'slug' => '11-inch', 'color_code' => null],
                ['value' => '12 inch', 'slug' => '12-inch', 'color_code' => null],
            ...
            'bluetooth-version' => [
                ...
                ['value' => '5.0', 'slug' => '5-0', 'color_code' => null],
                ['value' => '5.1', 'slug' => '5-1', 'color_code' => null],
                ['value' => '5.2', 'slug' => '5-2', 'color_code' => null],
                ['value' => '5.3', 'slug' => '5-3', 'color_code' => null],
            ],
            
            // ===== Color Type (Home) =====
            'color-type' => [
                ['value' => 'Warm', 'slug' => 'warm', 'color_code' => null],
                ['value' => 'Cool', 'slug' => 'cool', 'color_code' => null],
                ['value' => 'Neutral', 'slug' => 'neutral', 'color_code' => null],
                ['value' => 'Modern', 'slug' => 'modern', 'color_code' => null],
                ['value' => 'Classic', 'slug' => 'classic', 'color_code' => null],
            ],
            
            // ===== Product Type (Home) =====
            'product-type' => [
                ['value' => 'Furniture', 'slug' => 'furniture-pt', 'color_code' => null],
                ['value' => 'Lighting', 'slug' => 'lighting-pt', 'color_code' => null],
                ['value' => 'Kitchenware', 'slug' => 'kitchenware-pt', 'color_code' => null],
                ['value' => 'Decoration', 'slug' => 'decoration-pt', 'color_code' => null],
                ['value' => 'Bedding', 'slug' => 'bedding-pt', 'color_code' => null],
            ],
            ...
            'capacity' => [
                ...
                ['value' => '15L', 'slug' => '15l', 'color_code' => null],
                ['value' => '20L', 'slug' => '20l', 'color_code' => null],
                ['value' => '50L', 'slug' => '50l', 'color_code' => null],
                ['value' => '100L', 'slug' => '100l', 'color_code' => null],
            ],
            ...
            'power-usage' => [
                ...
                ['value' => '3000W', 'slug' => '3000w', 'color_code' => null],
            ],
            ...
            'metal-type' => [
                ...
                ['value' => 'Rose Gold', 'slug' => 'rose-gold', 'color_code' => null],
        ...
        // ================================================================
        // 3. LINK ATTRIBUTES TO CATEGORIES (ارتباط ویژگی‌ها با دسته‌بندی‌ها)
        // ================================================================
        ...
        $categoryAttributeMap = [
            // Mobile
            'Mobile' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant', 'camera-mp', 'sim-type', 'year', 'weight'],
            'Apple Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant', 'camera-mp', 'sim-type'],
            'Samsung Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant', 'camera-mp', 'sim-type'],
            'Xiaomi Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant', 'camera-mp', 'sim-type'],
            'Google Pixel' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant', 'camera-mp'],
            'OnePlus' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type', 'water-resistant'],
            'Huawei' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Nokia' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size'],
            'Sony Xperia' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'water-resistant'],
            
            // Laptops
            'Laptops' => ['color', 'size', 'material', 'weight', 'year', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            'Apple MacBooks' => ['color', 'material', 'weight', 'year', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            'Gaming Laptops' => ['color', 'material', 'weight', 'screen-size', 'graphics-card', 'ssd-storage', 'cpu-model'],
            'Business Laptops' => ['color', 'material', 'weight', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            'Ultrabooks' => ['color', 'material', 'weight', 'screen-size', 'ssd-storage', 'cpu-model'],
            ...
            'Wireless Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation', 'bluetooth-version'],
            'Smartwatches' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof', 'bluetooth-version'],
            'Samsung Smartwatches' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof'],
            'Xiaomi Smartwatches' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof'],
            'Sony Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation'],
            'JBL Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof'],
            'Apple AirPods' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation'],
            'Razer Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation'],
            'Cameras' => ['color', 'material', 'weight', 'connectivity', 'battery-life'],
            'Speakers' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof'],
            'Power Banks' => ['color', 'material', 'weight', 'capacity', 'battery'],
            
            // Gaming Consoles
            'PS5' => ['color', 'material', 'weight', 'connectivity', 'storage', 'ram'],
            'PS5 Slim' => ['color', 'material', 'weight', 'connectivity', 'storage', 'ram'],
            'PS5 Pro' => ['color', 'material', 'weight', 'connectivity', 'storage', 'ram'],
            'PS4' => ['color', 'material', 'weight', 'connectivity', 'storage'],
            'Xbox' => ['color', 'material', 'weight', 'connectivity', 'storage'],
            'Nintendo' => ['color', 'material', 'weight', 'connectivity', 'storage'],
            'Game Controllers' => ['color', 'material', 'weight', 'connectivity', 'battery-life'],
            'Racing Wheels' => ['color', 'material', 'weight', 'connectivity'],
            
            // Home & Kitchen
            'Home & Kitchen' => ['color', 'size', 'material', 'weight', 'year', 'color-type', 'product-type', 'capacity'],
            'Furniture' => ['color', 'size', 'material', 'weight', 'color-type', 'product-type'],
            'Lighting' => ['color', 'material', 'weight', 'color-type', 'power-usage'],
            'Kitchenware' => ['color', 'material', 'weight', 'capacity', 'product-type'],
            'Decorations' => ['color', 'material', 'weight', 'color-type', 'product-type'],
            'Rugs' => ['color', 'size', 'material', 'weight', 'color-type'],
            'Bedding' => ['color', 'size', 'material', 'weight', 'color-type'],
            ...
            'Kitchen Appliances' => ['color', 'material', 'weight', 'power-usage', 'capacity'],
            'Cleaning Appliances' => ['color', 'material', 'weight', 'power-usage', 'battery'],
            'Air Conditioners' => ['color', 'material', 'weight', 'power-usage', 'capacity'],
            'Microwaves' => ['color', 'material', 'weight', 'power-usage', 'capacity'],
            'Ovens' => ['color', 'material', 'weight', 'power-usage', 'capacity'],
            
            // Beauty & Health
            'Beauty & Health' => ['color', 'size', 'weight', 'year'],
            'Skin Care' => ['weight', 'year'],
            'Makeup' => ['color', 'weight'],
            'Perfumes' => ['color', 'size', 'weight'],
            'Hair Care' => ['size', 'weight'],
            ...
            'Bags & Wallets' => ['color', 'material', 'gender'],
            'Accessories' => ['color', 'material', 'gender'],
            'Sportswear' => ['color', 'clothing-size', 'fabric-type', 'gender'],
            ...
            // Vehicles
            'Vehicles' => ['engine-type', 'transmission', 'fuel-type', 'car-model-year', 'color', 'weight'],
            'Cars' => ['engine-type', 'transmission', 'fuel-type', 'car-model-year', 'color'],
            'Motorcycles' => ['engine-type', 'transmission', 'fuel-type', 'car-model-year', 'color'],
            'Car Accessories' => ['color', 'material', 'weight'],
            
            // Tools & Equipment
            'Tools & Equipment' => ['tool-type', 'power-source', 'voltage', 'material', 'weight'],
            'Power Tools' => ['tool-type', 'power-source', 'voltage', 'weight'],
            'Hand Tools' => ['tool-type', 'material', 'weight'],
            'Gardening Tools' => ['tool-type', 'material', 'weight'],
            'Safety Equipment' => ['material', 'weight'],
            'Tool Sets' => ['tool-type', 'material', 'weight'],
            
            // Books & Art
            'Books & Art' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count', 'year'],
            'Novels' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count'],
            'History Books' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count'],
            'Self-Help Books' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count'],
            'Children Books' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count'],
            'Art & Painting' => ['material', 'year'],
            'Handicrafts' => ['material', 'year'],
            
            // Sports & Travel
            'Sports & Travel' => ['sport-type', 'gender', 'size', 'material', 'weight'],
            'Sports Equipment' => ['sport-type', 'material', 'weight'],
            'Sportswear' => ['sport-type', 'gender', 'clothing-size', 'fabric-type'],
            'Travel Equipment' => ['material', 'weight', 'size'],
            'Outdoor Sports' => ['sport-type', 'material', 'weight'],
            'Camping' => ['sport-type', 'material', 'weight'],
            'Cycling' => ['sport-type', 'material', 'weight', 'size'],
            
            // Gift Cards
            'Gift Cards' => ['year'],
            'Store Gift Cards' => ['year'],
            'Digital Gift Cards' => ['year'],
            'Virtual Gift Cards' => ['year'],
        ];
        ...
        // ================================================================
        // 4. ATTACH ATTRIBUTES TO VARIANTS (اتصال ویژگی‌ها به تنوع‌ها)
        // ================================================================
