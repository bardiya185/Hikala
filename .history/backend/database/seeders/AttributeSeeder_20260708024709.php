...
class AttributeSeeder extends Seeder
{
    public function run()
    {
        ...
        // ================================================================
        // 3. LINK ATTRIBUTES TO CATEGORIES (ارتباط با دسته‌بندی‌ها)
        // ================================================================
        ...
        $categoryAttributeMap = [
            ...
            'Select Mobile' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Apple Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Samsung Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Xiaomi Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Google Pixel' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'OnePlus Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Huawei Phones' => ['color', 'storage', 'ram', 'processor', 'battery', 'display-size', 'display-type'],
            'Nokia Phones' => ['color', 'storage', 'ram', 'processor', 'battery'],
            'Motorola Phones' => ['color', 'storage', 'ram', 'processor', 'battery'],
            
            // ===== Laptops =====
            'Laptops' => ['color', 'size', 'material', 'weight', 'year', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            'Select Laptop' => ['color', 'size', 'material', 'weight', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            ...
            'MacBooks' => ['color', 'material', 'weight', 'screen-size', 'graphics-card', 'operating-system', 'ssd-storage', 'cpu-model'],
            'Surface Laptops' => ['color', 'material', 'weight', 'screen-size', 'operating-system', 'ssd-storage', 'cpu-model'],
            ...
            'Gaming Consoles' => ['color', 'material', 'weight', 'connectivity', 'storage', 'ram'],
            'Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation', 'bluetooth-version'],
            'Wireless Headphones' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'noise-cancellation'],
            'Smartwatches' => ['color', 'material', 'weight', 'connectivity', 'battery-life', 'waterproof'],
            'Tablets' => ['color', 'material', 'weight', 'screen-size', 'storage', 'ram'],
            ...
            'Computer Components' => ['color', 'material', 'weight', 'storage', 'ram', 'processor'],
            
            // ===== Home & Kitchen =====
            'Home & Kitchen' => ['color', 'size', 'material', 'weight', 'year', 'color-type', 'product-type', 'capacity'],
            'Cookware' => ['color', 'size', 'material', 'weight', 'capacity'],
            'Kitchenware' => ['color', 'size', 'material', 'weight', 'capacity'],
            ...
            'Carpets & Rugs' => ['color', 'size', 'material', 'weight', 'color-type'],
            'Bedroom' => ['color', 'size', 'material', 'weight', 'color-type'],
            ...
            'TVs' => ['color', 'material', 'weight', 'screen-size', 'display-type'],
            ...
            // ===== Health & Medical =====
            'Health & Medical' => ['weight', 'year'],
            'Medical Equipment' => ['weight', 'year'],
            'Supplements' => ['weight', 'year'],
            'Fitness Equipment' => ['material', 'weight'],
            ...
            'Books' => ['author', 'publisher', 'book-language', 'cover-type', 'pages-count'],
        ...
        // ================================================================
        // 4. ATTACH ATTRIBUTES TO VARIANTS
        // ================================================================
        ...
        foreach ($products as $product) {
            ...
            foreach ($variants as $variant) {
                $selectedCount = min(rand(4, 6), count($categoryAttrs));
