...
// ================================================================
// 4. ATTACH ATTRIBUTES TO VARIANTS (1-3 COLORS + 10 ATTRIBUTES)
// ================================================================

$this->command->info('🔄 Creating random attributes for all products...');

$products = DB::table('products')->get();
$allAttributeValues = DB::table('attribute_values')->get();

$colorAttribute = DB::table('attributes')
    ->where('slug', 'color')
    ->first();
...
foreach ($products as $product) {
    ...
    foreach ($variants as $variant) {
        ...
        /*
        |--------------------------------------------------------------------------
        | 1 تا 3 رنگ رندوم برای هر Variant
        |--------------------------------------------------------------------------
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | 10 ویژگی تصادفی برای هر Variant
        |--------------------------------------------------------------------------
        */


        $otherAttributes = collect($categoryAttrs)
            ->reject(fn($id) => $id == optional($colorAttribute)->id)
            ->shuffle();
