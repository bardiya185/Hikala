...
class DiscountSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // انتخاب ۵-۱۰ محصول تصادفی
        $productCount = min(count($allProducts), rand(5, 10));
        shuffle($allProducts);
        $selectedProducts = array_slice($allProducts, 0, $productCount);

        $this->command->info("🎯 Selected {$productCount} products for discounts.");
        ...
        // ================================================================
        // ۳. اتصال تخفیف‌ها به محصولات انتخاب‌شده (discountables)
        // ================================================================
        $this->command->info('🔗 Attaching discounts to selected products...');
