...
[
    ...
    'children' => [
        ...
        [
            ...
            'slug' => 'supplements',
            'children' => [
                ['name' => 'Vitamin C', 'slug' => 'vitamin-c-supplement'], // ✅ تغییر
                ['name' => 'Vitamin D3', 'slug' => 'vitamin-d3-supplement'], // ✅ تغییر
                ['name' => 'Omega-3', 'slug' => 'omega-3'],
                ['name' => 'Magnesium', 'slug' => 'magnesium'],
                ['name' => 'Zinc', 'slug' => 'zinc'],
                ['name' => 'B-Complex', 'slug' => 'b-complex'],
                ['name' => 'Protein Powder', 'slug' => 'protein-powder'],
                ['name' => 'Collagen', 'slug' => 'collagen'],
                ['name' => 'Probiotic', 'slug' => 'probiotic'],
                ['name' => 'Multivitamin', 'slug' => 'multivitamin'],
                ['name' => 'Calcium', 'slug' => 'calcium'],
                ['name' => 'Iron Supplement', 'slug' => 'iron-supplement'],
            ]
        ],
                ...
                'children' => [
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['name' => 'Sports Shorts', 'slug' => 'sports-shorts'],
                            ['name' => 'Track Suit', 'slug' => 'track-suit'],
                            ['name' => 'Compression Shirt', 'slug' => 'compression-shirt'],
                            ['name' => 'Compression Pants', 'slug' => 'compression-pants'],
                            ['name' => 'Sports Bra', 'slug' => 'sports-bra'],
                            ['name' => 'Sports Socks', 'slug' => 'sports-socks'],
                            ['name' => 'Sweatband', 'slug' => 'sweatband'],
                            ['name' => 'Headband', 'slug' => 'headband'],
                            ['name' => 'Wristband', 'slug' => 'wristband'],
                            ['name' => 'Sports Jacket', 'slug' => 'sports-jacket'],
                            ['name' => 'Sports Pants', 'slug' => 'sports-pants'],
                            ['name' => 'Nike Sportswear', 'slug' => 'nike-sportswear'],
                            ['name' => 'Adidas Sportswear', 'slug' => 'adidas-sportswear'],
                            ['name' => 'Puma Sportswear', 'slug' => 'puma-sportswear'],
                        ]
                    ],
                    [
