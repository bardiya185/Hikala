...
Route::prefix('campaigns')->group(function () {
    Route::get('/', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'index']);
    Route::get('/{slug}', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'showBySlug']);
});
