...
Route::prefix('admin')->group(function () {
    ...
    // ===== 🎯 Discount Campaigns =====
    Route::prefix('campaigns')->group(function () {
        Route::get('/', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'adminIndex']);
        Route::post('/', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'store']);
        Route::get('/{campaign}', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'show']);
        Route::put('/{campaign}', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'update']);
        Route::delete('/{campaign}', [\App\Http\Controllers\Api\DiscountCampaignController::class, 'destroy']);
    });
});