...
Route::prefix('admin')->group(function () {
    ...
    // ===== 🎯 Discount Campaigns =====
    Route::prefix('campaigns')->group(function () {
        Route::get('/', [\AppDiscountCampaignController::class, 'adminIndex']);
        Route::post('/', [\AppDiscountCampaignController::class, 'store']);
        Route::get('/{campaign}', [\AppDiscountCampaignController::class, 'show']);
        Route::put('/{campaign}', [\AppDiscountCampaignController::class, 'update']);
        Route::delete('/{campaign}', [\AppDiscountCampaignController::class