...
// ===== ⭐ Reviews (Authenticated) =====
    ...
    Route::get('/products/{product}/my-review', [App\Http\Controllers\Api\ReviewController::class, 'myReview']);
    ...
    Route::post('/reviews/{review}/reject', [App\Http\Controllers\Api\ReviewController::class, 'reject']);
