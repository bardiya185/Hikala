...
function ProductCard({ product }) {
  ...
  return (
    <div className="w-[180px] xs:w-[180px] sm:w-[170px] md:w-[200px] lg:w-[260px] bg-white rounded-lg sm:rounded-xl lg:rounded-2xl p-1.5 sm:p-2 lg:p-4 border border-neutral-300 shadow-sm shrink-0 flex flex-col hover:shadow-md transition-shadow">
