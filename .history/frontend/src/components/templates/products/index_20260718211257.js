...
function Products({ data, current_sort, current_sortorder }) {
  ...
  const splitInstances = useRef([]); // برای نگهداری نمونه‌های SplitText
  ...
  useEffect(() => {
    ...
    // پاک کردن نمونه‌های قبلی SplitText
    ...
    // ==========================================
    // 1. ابتدا همه چیز رو مخفی میکنیم (بدون پرش)
    // ==========================================
    ...
    // مخفی کردن تکست‌ها (با استفاده از CSS visibility)
    ...
    // ==========================================
    // 2. SplitText رو روی هر المان جداگانه اجرا میکنیم
    // ==========================================
    ...
    // انیمیشن کارت‌ها (از پایین به بالا)
    tl.to(cards, {
      opacity: 1,
      y: 0,
      scale: 1,
    ...
    // انیمیشن کلمات (با تاخیر نسبت به کارت‌ها)
    allWordElements.forEach((item, index) => {
      // هر گروه از کلمات با تاخیر جداگانه
