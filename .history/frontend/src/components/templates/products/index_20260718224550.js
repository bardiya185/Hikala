...
function ProductSkeleton() {
  return (
    <div className="w-full h-auto rounded-[20px] border border-neutral-100 border-l-indigo-700 p-3 animate-pulse ">
        ...
        {isLoading
          ...
          : data.map((ddd , index) => {
              ...
              return (
                ...
                transition={{ ease:'easeInOut', duration:0.2, delay: 0.1 * index  }}
