  ...
  return (
    <>
      ...
      <div className="flex gap-4 pl-4 mb-4 items-center" dir="ltr">
        ...
        <button
          className={`text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors ${current_sort === "base_price" && current_sortorder === "asc"
        ...
        <button
          className={`text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors ${current_sort === "base_price" && current_sortorder === "desc"
              ? "text-red-500 bg-red-50"
              : "text-neutral-400 hover:text-neutral-600"
            }`}
