                ...
                >
                  <div className="rounded-[10px] w-full h-full border border-solid border-neutral-100 p-4 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="w-full overflow-hidden rounded-[20px] aspect-[5/5] relative flex items-center justify-center">
                        <Image
                    ...
                    <div>
                      ...
                      >
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {discountPercent > 0 && (
                            <span className="text-neutral-400 line-through text-xs flex flex-wrap flex-column w-10">
