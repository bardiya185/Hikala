...
return [
     ...
     * اینجا مسیری که قبلاً فایل Annotations.php را ساختید، اسکن می‌شود
     */
              'annotations' => [
...
// ],
                ...
                /*
     * Directory to store the generated documentation
     */
        ...
        */
        'securityDefinitions' => [
            'securitySchemes' => [
                ...
                *thorizationUrl" => config('app.url') . '/oauth/authorize',
