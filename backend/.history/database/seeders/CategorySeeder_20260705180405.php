...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $headphone = Category::updateOrCreate(
            ['slug' => 'headphone'],
            [
                'parent_id' => null,
                'name' => 'هدفون',
        ...
        $subs = [
            ['هدفون بی‌سیم', 'wireless-headphone'],
            ['هدفون سیمی', 'wired-headphone'],
            ['ایرپاد', 'airpods'],
        ];

        $order = 1;

        foreach ($subs as [$name, $slug]) {

            Category::updateOrCreate(
                ['slug' => $slug],
                [
                    'parent_id' => $headphone->id,
                    'name' => $name,
                    'sort_order' => $order++,
                    'is_active' => true,
                ]
        ...
        $subs = [
            ...
            ['شیائومی واچ','xiaomi-watch'],
        
            ['هواوی واچ','huawei-watch'],
