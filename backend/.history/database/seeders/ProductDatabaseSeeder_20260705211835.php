...
class SimpleProductSeeder extends Seeder
{
    public function run()
    {
        ...
        // ========== 3. تعریف محصولات با دسته و برند درست ==========
        $productsData = [
            // ===== موبایل =====
        ...
        foreach ($productsData as $productData) {
            ...
            for ($v = 1; $v <= $variantCount; $v++) {
                ...
                DB::table('product_variants')->insert([
                    ...
                    'stock' => rand(5, 50),
                    'weight' => $productData['weight'] * rand(8, 12) / 10, // تغییر وزن برای هر تنوع
                    'is_active' => 1,
                    'created_at' => now(),
                    'updated_at' => now()
                ]);
        ...
        $this->command->info('✅ ' . $productCount . ' products with ' . $variantCount . ' variants created!');
