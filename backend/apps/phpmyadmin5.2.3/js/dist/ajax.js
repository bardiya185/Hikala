...
var AJAX = {
    ...
    requestHandler: function (event) {
        ...
        if (
            ...
            $(this).hasClass("ui-datepicker-next") ||
    ...
    loginResponseHandler: function (data) {
        ...
        if (typeof data.success !== "undefined" && data.success) {
            ...
            if (typeof data.logged_in !== "undefined" && data.logged_in === 1) {
                ...
                $("fieldset.disabled_for_expiration")
                    .removeAttr("disabled")
                    .removeClass("disabled_for_expiration");
            ...
            typeof data.logged_in !== "undefined" &&
            data.logged_in === 0
        ) {
            ...
            AJAX.scriptHandler.reset(function () {
                ...
                if (data.selflink) {
                    ...
                    var $selflinkReplace = {
                        ...
                        "index.php?route=/table/gis-visualization":
                            "index.php?route=/sql",
                    };
                    if ($selflinkReplace[source]) {
                        var replacement = $selflinkReplace[source];
                        data.selflink = data.selflink.replace(
                            source,
                            replacement,
                        );
                    }
    ...
    scriptHandler: {
         ...
         */
            ...
            if ($.inArray(script, this.scriptsToBeLoaded)) {
                this.scriptsToBeLoaded.splice(
                    $.inArray(script, this.scriptsToBeLoaded),
                    1,
                );
            }
            if (script === null) {
            ...
            AJAX.active =
                this.scriptsToBeLoaded.length > 0 || !this.scriptsCompleted;
        ...
        appendScript: function (name, callback) {
            ...
            script.src =
                ...
                "?" +
                "v=" +
                encodeURIComponent(CommonParams.get("version"));
            script.async = false;
        ...
        reset: function (callback) {
            ...
            $(document)
                .off("submit", "form")
                .on("submit", "form", AJAX.requestHandler);
            callback();
        },
    },
};
        ...
        if (request.status !== 0) {
            details +=
                ...
                Functions.escapeHtml(
                    Functions.sprintf(Messages.strErrorCode, request.status),
                ) +
                "</div>";
        }
        details +=
            ...
            Functions.escapeHtml(
                Functions.sprintf(
                    Messages.strErrorText,
                    request.statusText + " (" + state + ")",
                ),
            ) +
            "</div>";
