...
AJAX.registerOnload("server/status/variables.js", function () {
    ...
    $("#dontFormat")
        .on("change", function () {
            ...
            serverStatusVariables
                .find("td.value span.original")
                .toggle(this.checked);
            serverStatusVariables
                .find("td.value span.formatted")
                .toggle(!this.checked);
    ...
    function filterVariables() {
        ...
        $("#serverStatusVariables")
            ...
            .each(function () {
                if (
                    (textFilter === null || textFilter.exec($(this).text())) &&
                    (!alertFilter ||
                        $(this).next().find("span.text-danger").length > 0) &&
                    (categoryFilter.length === 0 ||
                        $(this)
                            .parent()
                            .hasClass("s_" + categoryFilter))
                ) {
