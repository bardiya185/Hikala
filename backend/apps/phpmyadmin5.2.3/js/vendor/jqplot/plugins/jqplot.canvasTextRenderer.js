...
(function ($) {
    ...
    $.jqplot.CanvasTextRenderer.prototype.measure = function (ctx, str) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (c) {
                total +=
                    ((c.width * this.normalizedFontSize) / 25.0) *
                    this.fontStretch;
            }
        }
        return total;
    ...
    $.jqplot.CanvasTextRenderer.prototype.draw = function (ctx, str) {
        ...
        if (
            ...
            ((-Math.PI * 3) / 2 < this.angle && this.angle < Math.PI) ||
    ...
    $.jqplot.CanvasFontRenderer.prototype.constructor =
