...
(function ($) {
    ...
    $.jqplot.EnhancedPieLegendRenderer.prototype =
        new $.jqplot.TableLegendRenderer();
    $.jqplot.EnhancedPieLegendRenderer.prototype.constructor =
    ...
    $.jqplot.EnhancedPieLegendRenderer.prototype.draw = function (
        offsets,
        plot,
    ) {
        var legend = this;
        if (this.show) {
            ...
            for (i = series.length - 1; i >= 0; i--) {
                if (
                    (nc == 1 && series[i]._stack) ||
                    series[i].renderer.constructor ==
                    ...
                    if (idx < slen) {
                        ...
                        if (lt) {
                            ...
                            if (this.seriesToggle) {
                                var speed;
                                if (
                                    typeof this.seriesToggle === "string" ||
    ...
    var handleToggle = function (ev) {
        ...
        d.series.showSlice[idx] =
            d.series.showSlice[idx] === false ? true : false;
    ...
    var postDraw = function () {
        if (
            this.legend.renderer.constructor ==
                $.jqplot.EnhancedPieLegendRenderer &&
