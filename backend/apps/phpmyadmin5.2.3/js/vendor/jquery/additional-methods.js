...
(function (factory) {
    ...
    $.validator.addMethod(
        ...
        function (value, element) {
            ...
            control_digit =
                parseInt(control_digit, 10) > 9 ? "0" : control_digit;
        ...
        function (value, element) {
            ...
            if (checkResult(sum, firstCN)) {
                ...
                for (i = 1; i <= 10; i++) {
                    sum =
                        sum +
                        parseInt(value.substring(i - 1, i), 10) * (12 - i);
                }
    ...
    $.validator.addMethod(
        ...
        function (value, element) {
            ...
            if (typeof bbanpattern !== "undefined") {
                ibanregexp = new RegExp(
                    "^[A-Z]{2}\\d{2}" + bbanpattern + "$",
                    "",
                );
            ...
            for (i = 0; i < ibancheck.length; i++) {
                ...
                if (!leadingZeroes) {
                    ibancheckdigits +=
                        "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(charAt);
                }
            }
    ...
    $.validator.addMethod(
        ...
        function (value, element) {
            ...
            number =
                value.length === 9 ? value.substr(0, 8) : value.substr(0, 9);
    ...
    $.validator.addMethod(
        ...
        function (value, element, options) {
            var isDefault = typeof options === "undefined",
                ...
                includeTerritories =
                    isDefault ||
                    typeof options.includeTerritories === "undefined"
                        ? false
    ...
    $.validator.addMethod(
        ...
        function (value, element) {
            return (
                this.optional(element) || /^90[2-5]\d\{2\}-\d{4}$/.test(value)
            );
        },
