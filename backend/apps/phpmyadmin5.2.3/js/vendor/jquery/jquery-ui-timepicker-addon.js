...
(function (factory) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        _newInst: function ($input, opts) {
            ...
            var timezoneList = [
                ...
                300, 330, 345, 360, 390, 420, 480, 525, 540, 570, 600, 630, 660,
                690, 720, 765, 780, 840,
            ];
                        ...
                        if (this.minute <= this._defaults.minuteMin) {
                            ...
                            if (this.second <= this._defaults.secondMin) {
                                ...
                                this._defaults.millisecMin =
                                    minDateTime.getMilliseconds();
                                if (
                                    this.millisec <= this._defaults.millisecMin
                                ) {
                                    this.millisec = this._defaults.millisecMin;
                                    this._defaults.microsecMin =
                                        minDateTime.getMicroseconds();
                                } else {
                                    if (
                                        this.microsec <
                                        this._defaults.microsecMin
                        ...
                        if (this.minute >= this._defaults.minuteMax) {
                            ...
                            if (this.second >= this._defaults.secondMax) {
                                ...
                                this._defaults.millisecMax =
                                    maxDateTime.getMilliseconds();
                                if (
                                    this.millisec >= this._defaults.millisecMax
                                ) {
                                    this.millisec = this._defaults.millisecMax;
                                    this._defaults.microsecMax =
                                        maxDateTime.getMicroseconds();
                                } else {
                                    if (
                                        this.microsec >
                                        this._defaults.microsecMax
    ...
    $.datepicker._gotoToday = function (id) {
        ...
        var now = new Date();
        now.setMinutes(
            now.getMinutes() + now.getTimezoneOffset() + parseInt(tzoffset, 10),
        );
    ...
    $.datepicker._setDateDatepicker = function (target, _date) {
        ...
        if (tp_inst && tp_date) {
            ...
            tp_date = $.timepicker.timezoneAdjust(
                tp_date,
                $.timepicker.timezoneOffsetString(-tp_date.getTimezoneOffset()),
                tp_inst.timezone,
            );
        }
