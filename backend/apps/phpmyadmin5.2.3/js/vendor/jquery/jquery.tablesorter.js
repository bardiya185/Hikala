    ...
    (function ($) {
		...
		*/
            ...
            setup: function (table, c) {
                ...
                ts.bindMethods(c);
                if (
                    c.supportsDataObject &&
                    typeof $table.data().sortlist !== "undefined"
                ) {
            ...
            bindMethods: function (c) {
                ...
                $table
                    ...
                    .bind(
                        "sorton" + namespace,
                        function (e, list, callback, init) {
                            e.stopPropagation();
                            ts.sortOn(this.config, list, callback, init);
                        },
                    )
                    .bind(
                        "appendCache" + namespace,
                        function (e, callback, init) {
                            e.stopPropagation();
                    ...
                    .bind(
                        "refreshWidgets" + namespace,
                        function (e, all, dontapply) {
                            e.stopPropagation();
                            ts.refreshWidgets(this, all, dontapply);
                        },
                    )
                    .bind(
                        "removeWidget" + namespace,
                        function (e, name, refreshing) {
                            e.stopPropagation();
            ...
            bindEvents: function (table, $headers, core) {
                ...
                $headers
                    ...
                    .bind(tmp, function (e, external) {
                        ...
                        c.last.clickedIndex =
                            $cell.attr("data-column") || $cell.index();
                        ...
                        function (elem, index) {
                            ...
                            if (
                                ...
                                template = c.headerTemplate
                                    .replace(
                                        ts.regex.templateContent,
                                        $elem.html(),
                                    )
                                    .replace(
                                        ts.regex.templateIcon,
                                        $elem.find("." + ts.css.icon).length
                                            ? ""
                                            : icon,
                                    );
                            ...
                            ts.getClosest($elem, "tr")
                                .addClass(
                                    ts.css.headerRow + " " + c.cssHeaderRow,
                                )
                                .attr("role", "row");
                            if (c.tabIndex) {
		...
		*/
            setupParsers: function (c, $tbodies) {
                ...
                if (debug) {
                    ...
                    console.log(
                        "Completed detecting parsers" + ts.benchmark(time),
                    );
                    if (console.groupEnd) {
                        console.groupEnd();
                    }
            ...
            getElementText: function (c, node, cellIndex) {
                ...
                if (typeof extract === "string") {
                    if (
                        extract === "basic" &&
                        typeof (tmp = $node.attr(c.textAttribute)) !==
                            "undefined"
                    ) {
                        return $.trim(tmp);
                    }
		...
		*/
            buildCache: function (c, callback, $tbodies) {
                ...
                (($tbody =
                    typeof $tbodies === "undefined" ? c.$tbodies : $tbodies),
                    (c.cache = {}));
                c.totalRows = 0;
                if (!parsers) {
                    return debug
                    ...
                    for (rowIndex = 0; rowIndex < totalRows; ++rowIndex) {
                        ...
                        if ($row.hasClass(c.cssChildRow) && rowIndex !== 0) {
                            ...
                            for (colIndex = 0; colIndex < max; colIndex++) {
                                cell = $cells[colIndex];
                                if (cell) {
                                    prevRowData.child[len][colIndex] =
                                        ts.getParsedText(c, cell, colIndex);
                        ...
                        for (colIndex = 0; colIndex < max; ++colIndex) {
                            ...
                            if (cell && cacheIndex < c.columns) {
                                hasParser =
                                    typeof parsers[cacheIndex] !== "undefined";
                                if (!hasParser && debug) {
                                    console.warn(
                ...
                if (ts.isEmptyObject(c)) {
                    ...
                    for (tbodyIndex = 0; tbodyIndex < tbodyLen; tbodyIndex++) {
                        ...
                        for (rowIndex = 0; rowIndex < rowLen; rowIndex++) {
                            ...
                            if (
                                rowFilter &&
                                !row[c.columns].$row.is(rowFilter)
                            ) {
                                continue;
                            }
                            result = true;
		...
		*/
                        ...
                        $sorted = c.$headers.filter(function (i) {
                            var include = true,
                                ...
                                col = parseInt($el.attr("data-column"), 10),
                                    ...
                                    col +
                                    ts.getClosest($el, "th, td")[0].colSpan;
                            for (; col < end; col++) {
                                include = include
                                    ? include ||
                                      ts.isValueInArray(col, c.sortList) > -1
                                    : false;
                            }
                            return include;
                        });
            ...
            updateHeader: function (c) {
                ...
                for (index = 0; index < len; index++) {
                    ...
                    isDisabled =
                        ts.getData($header, col, "sorter") === "false" ||
                        ts.getData($header, col, "parser") === "false";
                    ...
                    if (col < c.columns) {
                        ...
                        switch (dir) {
                            ...
                            case "n":
                                dir =
                                    order[
                                        ++c.sortVars[col].count % order.length
                                    ];
                                break;
                            default: // ascending
                                dir = 0;
            ...
            updateCell: function (c, cell, resort, callback) {
                ...
                if ($tbodies.length && tbodyIndex >= 0) {
                    ...
                    if (
                        (c.parsers[icell].type || "").toLowerCase() ===
                        "numeric"
                    ) {
                ...
                if (ts.isEmptyObject(c.cache)) {
                    ...
                    for (rowIndex = 0; rowIndex < rows; rowIndex++) {
                        ...
                        for (cellIndex = 0; cellIndex < len; cellIndex++) {
                            ...
                            if (
                                (
                                    c.parsers[cacheIndex].type || ""
                                ).toLowerCase() === "numeric"
                            ) {
                                c.cache[tbodyIndex].colMax[cacheIndex] =
                                    Math.max(
                                        Math.abs(val) || 0,
                                        c.cache[tbodyIndex].colMax[
                                            cacheIndex
                                        ] || 0,
                                    );
                            }
                    ...
                    if (c.sortForce !== null) {
                        ...
                        for (indx = 0; indx < arry.length; indx++) {
                            if (arry[indx][0] !== col) {
                                ...
                                c.sortVars[arry[indx][0]].sortedBy =
                                    "sortForce";
                            }
                        }
                    }
                    ...
                    if (dir < 2) {
                        ...
                        if (th.colSpan > 1) {
                            for (indx = 1; indx < th.colSpan; indx++) {
                                ...
                                c.sortVars[col + indx].count = $.inArray(
                                    dir,
                                    order,
                                );
                    ...
                    rows.sort(function (a, b) {
                        ...
                        for (sortIndex = 0; sortIndex < sortLen; sortIndex++) {
                            ...
                            if (num && c.strings[col]) {
                                if (
                                    typeof ts.string[c.strings[col]] ===
                                    "boolean"
                                ) {
                                    num =
                                        (dir ? 1 : -1) *
            ...
            sortOn: function (c, list, callback, init) {
                ...
                for (indx = 0; indx < c.columns; indx++) {
                    c.sortVars[indx].sortedBy =
                        ts.isValueInArray(indx, list) > -1 ? "sorton" : "";
                }
		...
		*/
            ...
            addWidgetFromClass: function (table) {
                var len,
                    ...
                    regex =
                        "^" +
                        c.widgetClass.replace(
                            ts.regex.templateName,
                            "(\\S+)+",
                        ) +
                        "$",
		...
		*/
            ...
            debug: function (c, name) {
                return (
                    c &&
                    (c.debug === true ||
                        (typeof c.debug === "string" &&
                            c.debug.indexOf(name) > -1))
                );
            },
            ...
            fixColumnWidth: function (table) {
                ...
                if (
                    c.widthFixed &&
                    c.$table.children("colgroup").length === 0
                ) {
                    ...
                    for (index = 0; index < len; index++) {
                        percent =
                            parseInt(
                                ($tbodies.eq(index).width() / overallWidth) *
                                    1000,
                                10,
                            ) /
                                10 +
            ...
            getData: function (header, configHeader, key) {
                ...
                if (
                    typeof $header.data(key) !== "undefined" ||
                    ...
                    configHeader &&
                    typeof configHeader[key] !== "undefined"
                ) {
            ...
            validateOptions: function (c) {
                ...
                if (orig) {
                    ...
                    if (ts.debug(c, "core")) {
                        console.log(
                            "validate options time:" + ts.benchmark(timer),
                        );
                    }
                }
            },
            ...
            destroy: function (table, removeClasses, callback) {
                ...
                events =
                    ...
                    "keypress sortBegin sortEnd resetToLoadState "
                        .split(" ")
                        .join(c.namespace + " ");
                $t.removeData("tablesorter").unbind(
                    events.replace(ts.regex.spaces, " "),
                );
                c.$headers
                    .add($f)
                    .removeClass(
        ...
        ts.addParser({
            ...
            format: function (str) {
                var date = str
                    ? new Date(str.replace(ts.regex.dash, "/"))
                    : str;
        ...
        ts.addParser({
            ...
            format: function (str) {
                var temp,
                    ...
                    orig = new Date(str),
                    time =
                        str && (timePart !== null ? timePart[0] : "00:00 AM"),
                    date = time
                        ? new Date(
                              "2000/01/01 " +
            ...
            format: function (table, c, wo) {
                ...
                for (
                    ...
                    for (rowIndex = 0; rowIndex < len; rowIndex++) {
                        ...
                        isEven = count % 2 === 0;
                        $row.removeClass(wo.zebra[isEven ? 1 : 0]).addClass(
                            wo.zebra[isEven ? 0 : 1],
                        );
                    }
                }
