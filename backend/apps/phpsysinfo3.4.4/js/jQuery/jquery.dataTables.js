...
(function ($, window, document) {
    ...
    _oExt.oJUIClasses = {
        ...
        sPageNextEnabled:
            "fg-button ui-button ui-state-default ui-corner-right",
        sPageNextDisabled:
    ...
    _oExt.oPagination = {
        ...
        two_button: {
            ...
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                $(nPrevious).on("selectstart.DT", function () {
                    return false;
                });
                $(nNext).on("selectstart.DT", function () {
                    return false;
                });
                ...
                if (
                    ...
                    nPaging.setAttribute(
                        "id",
                        oSettings.sTableId + "_paginate",
                    );
                    nPrevious.setAttribute(
                        "id",
                        oSettings.sTableId + "_previous",
                    );
        ...
        full_numbers: {
            ...
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                nFirst.className =
                    oClasses.sPageButton + " " + oClasses.sPageFirst;
                nPrevious.className =
                    oClasses.sPageButton + " " + oClasses.sPagePrevious;
                nNext.className =
                    oClasses.sPageButton + " " + oClasses.sPageNext;
                nLast.className =
                    oClasses.sPageButton + " " + oClasses.sPageLast;
            ...
            fnUpdate: function (oSettings, fnCallbackDraw) {
                ...
                if (iPages < iPageCount) {
                    ...
                    if (iCurrentPage <= iPageCountHalf) {
                        ...
                        if (iCurrentPage >= iPages - iPageCountHalf) {
                            ...
                            iStartButton =
                                iCurrentPage - Math.ceil(iPageCount / 2) + 1;
                ...
                var fnClick = function (e) {
                    ...
                    oSettings._iDisplayStart =
                        iTarget * oSettings._iDisplayLength;
                    fnCallbackDraw(oSettings);
                    e.preventDefault();
                };
    ...
    _oExt.aTypes = [
        ...
        function (sData) {
            ...
            if (
                (iParse !== null && !isNaN(iParse)) ||
                (typeof sData == "string" && sData.length === 0)
            ) {
                return "date";
            }
            return null;
    ...
    $.fn.dataTable = function (oInit) {
        ...
        function classSettings() {
            ...
            this.fnDisplayEnd = function () {
                if (this.oFeatures.bServerSide) {
                    if (
                        this.oFeatures.bPaginate === false ||
        ...
        this.fnDeleteRow = function (mTarget, fnCallBack, bRedraw) {
            ...
            iAODataIndex =
                typeof mTarget == "object"
                    ? _fnNodeToDataIndex(oSettings, mTarget)
                    : mTarget;
        ...
        this.fnGetData = function (mRow, iCol) {
            ...
            if (typeof mRow != "undefined") {
                var iRow =
                    typeof mRow == "object"
                        ? _fnNodeToDataIndex(oSettings, mRow)
                        : mRow;
        ...
        this.fnGetPosition = function (nNode) {
            ...
            if (sNodeName == "TR") {
                ...
                var iDataIndex = _fnNodeToDataIndex(
                    oSettings,
                    nNode.parentNode,
                );
                ...
                for (var i = 0; i < oSettings.aoColumns.length; i++) {
                    if (anCells[i] == nNode) {
                        return [
                            iDataIndex,
                            _fnColumnIndexToVisible(oSettings, i),
                            i,
                        ];
                    }
                }
        ...
        this.fnUpdate = function (mData, mRow, iColumn, bRedraw, bAction) {
            ...
            if ($.isArray(mData) && typeof mData == "object") {
                ...
                if (oSettings.aoData[iRow].nTr !== null) {
                    _fnGetTdNodes(oSettings, iRow)[iColumn].innerHTML =
                        sDisplay;
                }
            }
        ...
        this.fnSetColumnVis = function (iCol, bShow, bRedraw) {
            ...
            for (i = 0, iLen = oSettings.aoOpenRows.length; i < iLen; i++) {
                oSettings.aoOpenRows[i].nTr.colSpan =
        ...
        this.fnDestroy = function () {
            ...
            for (
                i = 0, iLen = oSettings.aoDestroyCallback.length;
                i < iLen;
                i++
            ) {
            ...
            $("tbody>tr>td." + oSettings.oClasses.sRowEmpty, oSettings.nTable)
                .parent()
                .remove();
            ...
            if (
                oSettings.nTFoot &&
                oSettings.nTable != oSettings.nTFoot.parentNode
            ) {
            ...
            if (!oSettings.bJUI) {
                $("th", oSettings.nTHead).removeClass(
                    [
                        _oExt.oStdClasses.sSortable,
                        _oExt.oStdClasses.sSortableAsc,
                        _oExt.oStdClasses.sSortableDesc,
                        _oExt.oStdClasses.sSortableNone,
                    ].join(" "),
                );
            } else {
                $("th", oSettings.nTHead).removeClass(
                    [
                        ...
                        _oExt.oJUIClasses.sSortableNone,
                    ].join(" "),
                );
                $(
                ...
                $("th", oSettings.nTHead).each(function () {
                    var jqWrapper = $(
                        "div." + _oExt.oJUIClasses.sSortJUIWrapper,
                        this,
                    );
            ...
            if (oSettings.nTableReinsertBefore) {
                nOrig.insertBefore(
                    oSettings.nTable,
                    oSettings.nTableReinsertBefore,
                );
            } else {
            ...
            if (oSettings.oFeatures.bAutoWidth === true) {
                oSettings.nTable.style.width = _fnStringToCss(
                    oSettings.sDestroyWidth,
                );
            }
            ...
            $(nBody)
                .children("tr:even")
                .addClass(oSettings.asDestroyStripes[0]);
        ...
        function _fnInitialise(oSettings) {
            ...
            for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                if (oSettings.aoColumns[i].sWidth !== null) {
                    oSettings.aoColumns[i].nTh.style.width = _fnStringToCss(
                ...
                oSettings.fnServerData.call(
                    ...
                    function (json) {
                        ...
                        if (oSettings.sAjaxDataProp !== "") {
                            var fnDataSrc = _fnGetObjectDataFn(
                        ...
                        if (oSettings.oFeatures.bSort) {
                            ...
                            oSettings.aiDisplay =
                                oSettings.aiDisplayMaster.slice();
                            _fnCalculateEnd(oSettings);
                            _fnDraw(oSettings);
                        }
        ...
        function _fnLanguageProcess(oSettings, oLanguage, bInit) {
             ...
             */
            if (
                typeof oLanguage.sEmptyTable == "undefined" &&
            ...
            if (
                typeof oLanguage.sLoadingRecords == "undefined" &&
                typeof oLanguage.sZeroRecords != "undefined"
            ) {
                _fnMap(
                    oSettings.oLanguage,
        ...
        function _fnAddColumn(oSettings, nTh) {
            ...
            if (
                typeof oSettings.aoPreSearchCols[iCol] == "undefined" ||
                ...
                if (
                    typeof oSettings.aoPreSearchCols[iCol].bRegex == "undefined"
                ) {
                    oSettings.aoPreSearchCols[iCol].bRegex = true;
                }

                if (
                    typeof oSettings.aoPreSearchCols[iCol].bSmart == "undefined"
                ) {
        ...
        function _fnCreateTr(oSettings, iRow) {
            ...
            if (oData.nTr === null) {
                ...
                for (
                    var i = 0, iLen = oSettings.aoColumns.length;
                    i < iLen;
                    i++
                ) {
                    ...
                    if (
                        typeof oCol.fnRender == "function" &&
                        (!oCol.bUseRendered || oCol.mDataProp === null)
                    ) {
        ...
        function _fnGatherData(oSettings) {
            ...
            if (nTds.length != nTrs.length * oSettings.aoColumns.length) {
                _fnLog(
                    oSettings,
                    1,
                    "Unexpected number of TD elements. Expected " +
            ...
            for (
                iColumn = 0, iColumns = oSettings.aoColumns.length;
                iColumn < iColumns;
                iColumn++
            ) {
                if (oSettings.aoColumns[iColumn].sTitle === null) {
                    oSettings.aoColumns[iColumn].sTitle =
                        oSettings.aoColumns[iColumn].nTh.innerHTML;
                }

                var bAutoType = oSettings.aoColumns[iColumn]._bAutoType,
                    bRender =
                        typeof oSettings.aoColumns[iColumn].fnRender ==
                        "function",
                ...
                if (bAutoType || bRender || bClass || !bVisible) {
                    for (
                        iRow = 0, iRows = oSettings.aoData.length;
                        iRow < iRows;
                        iRow++
                    ) {
                        ...
                        if (
                            ...
                            if (sValType !== "") {
                                ...
                                if (
                                    oSettings.aoColumns[iColumn].sType === null
                                ) {
        ...
        function _fnBuildHead(oSettings) {
            ...
            if (oSettings.oClasses.sFooterTH !== "") {
                $(oSettings.nTFoot)
                    .children("tr")
                    .children("th")
                    .addClass(oSettings.oClasses.sFooterTH);
            }

            if (oSettings.nTFoot !== null) {
                var anCells = _fnGetUniqueThs(
                    oSettings,
                    null,
                    oSettings.aoFooter,
                );
        ...
        function _fnDrawHead(oSettings, aoSource, bIncludeHidden) {
            ...
            for (i = 0, iLen = aoLocal.length; i < iLen; i++) {
                if (aoLocal[i].nTr) {
                    for (
                        k = 0, kLen = aoLocal[i].nTr.childNodes.length;
                        k < kLen;
                        k++
                    ) {
                        aoLocal[i].nTr.removeChild(
                            aoLocal[i].nTr.childNodes[0],
                        );
                    }
                }
                ...
                for (j = 0, jLen = aoLocal[i].length; j < jLen; j++) {
                    ...
                    if (typeof aApplied[i][j] == "undefined") {
                        ...
                        while (
                            typeof aoLocal[i + iRowspan] != "undefined" &&
                        ...
                        while (
                            typeof aoLocal[i][j + iColspan] != "undefined" &&
        ...
        function _fnDraw(oSettings) {
            ...
            if (
                oSettings.fnPreDrawCallback !== null &&
                oSettings.fnPreDrawCallback.call(
                    oSettings.oInstance,
                    oSettings,
                ) === false
            ) {
            ...
            if (oSettings.aiDisplay.length !== 0) {
                ...
                for (var j = iStart; j < iEnd; j++) {
                    ...
                    if (iStripes !== 0) {
                        var sStripe =
                            oSettings.asStripeClasses[iRowCount % iStripes];
                    ...
                    if (typeof oSettings.fnRowCallback == "function") {
                        nRow = oSettings.fnRowCallback.call(
                            oSettings.oInstance,
                            nRow,
                ...
                if (
                    ...
                    typeof oSettings.oLanguage.sEmptyTable != "undefined" &&
            ...
            if (typeof oSettings.fnHeaderCallback == "function") {
                oSettings.fnHeaderCallback.call(
                    oSettings.oInstance,
            ...
            if (typeof oSettings.fnFooterCallback == "function") {
                oSettings.fnFooterCallback.call(
                    oSettings.oInstance,
            ...
            for (i = oSettings.aoDrawCallback.length - 1; i >= 0; i--) {
                oSettings.aoDrawCallback[i].fn.call(
                    oSettings.oInstance,
                    oSettings,
                );
            }
        ...
        function _fnAjaxParameters(oSettings) {
            ...
            for (i = 0; i < iColumns; i++) {
                ...
                aoData.push({
                    name: "mDataProp_" + i,
                    value:
                        typeof mDataProp == "function" ? "function" : mDataProp,
                });
            }
            ...
            if (oSettings.oFeatures.bSort !== false) {
                var iFixed =
                    oSettings.aaSortingFixed !== null
                        ? oSettings.aaSortingFixed.length
                        : 0;
        ...
        function _fnServerParams(oSettings, aoData) {
            for (
                var i = 0, iLen = oSettings.aoServerParams.length;
                i < iLen;
                i++
            ) {
                oSettings.aoServerParams[i].fn.call(
                    oSettings.oInstance,
                    aoData,
                );
            }
        ...
        function _fnAjaxUpdateDraw(oSettings, json) {
            ...
            var bReOrder =
                typeof json.sColumns != "undefined" &&
                sOrdering !== "" &&
                json.sColumns != sOrdering;
            if (bReOrder) {
            ...
            for (var i = 0, iLen = aData.length; i < iLen; i++) {
                if (bReOrder) {
                    var aDataSorted = [];
                    for (
                        var j = 0, jLen = oSettings.aoColumns.length;
                        j < jLen;
                        j++
                    ) {
        ...
        function _fnAddOptionsHtml(oSettings) {
            ...
            oSettings.nTable.parentNode.insertBefore(
                nHolding,
                oSettings.nTable,
            );
            ...
            if (oSettings.sTableId !== "") {
                oSettings.nTableWrapper.setAttribute(
                    "id",
                    oSettings.sTableId + "_wrapper",
                );
            }
        ...
        function _fnFeatureHtmlTable(oSettings) {
            ...
            var nScroller = document.createElement("div"),
                ...
                nTfoot =
                    oSettings.nTable.getElementsByTagName("tfoot").length === 0
                        ? null
                        : oSettings.nTable.getElementsByTagName("tfoot")[0],
                oClasses =
                    typeof oInit.bJQueryUI != "undefined" && oInit.bJQueryUI
                        ? _oExt.oJUIClasses
                        : _oExt.oStdClasses;
            ...
            if (oSettings.oScroll.sX !== "") {
                ...
                if (nTfoot !== null) {
                    nScrollFoot.style.width = _fnStringToCss(
                        oSettings.oScroll.sX,
                    );
                }
                ...
                $(nScrollBody).scroll(function () {
                    if (!oSettings.bDrawing) {
                        if (
                            ...
                            $(oSettings.nTable).height() -
                                oSettings.oScroll.iLoadGap
                        ) {
                            if (
                                oSettings.fnDisplayEnd() <
                                oSettings.fnRecordsDisplay()
        ...
        function _fnScrollDraw(o) {
            var nScrollHeadInner = o.nScrollHead.getElementsByTagName("div")[0],
                nScrollHeadTable =
                    nScrollHeadInner.getElementsByTagName("table")[0],
                ...
                nScrollFootInner =
                    o.nTFoot !== null
                        ? o.nScrollFoot.getElementsByTagName("div")[0]
                        : null,
                nScrollFootTable =
                    o.nTFoot !== null
                        ? nScrollFootInner.getElementsByTagName("table")[0]
                        : null,
            ...
            if (o.oScroll.sX === "") {
                ...
                if (
                    ie67 &&
                    (nScrollBody.scrollHeight > nScrollBody.offsetHeight ||
                        $(nScrollBody).css("overflow-y") == "scroll")
                ) {
                    o.nTable.style.width = _fnStringToCss(
                        $(o.nTable).outerWidth() - o.oScroll.iBarWidth,
                    );
                }
            } else {
                if (o.oScroll.sXInner !== "") {
                    ...
                    iSanityWidth == $(nScrollBody).width() &&
                    $(nScrollBody).height() < $(o.nTable).height()
                ) {
                    o.nTable.style.width = _fnStringToCss(
                        iSanityWidth - o.oScroll.iBarWidth,
                    );
                    if (
                        $(o.nTable).outerWidth() >
                        iSanityWidth - o.oScroll.iBarWidth
            ...
            if ($(o.nTable).outerWidth() < iSanityWidth) {
                ...
                if (
                    ...
                    o.nTable.style.width = _fnStringToCss(
                        iCorrection - o.oScroll.iBarWidth,
                    );
                }

                nScrollBody.style.width = _fnStringToCss(iCorrection);
                nScrollHeadInner.parentNode.style.width =
                    _fnStringToCss(iCorrection);

                if (o.nTFoot !== null) {
                    nScrollFootInner.parentNode.style.width =
                        _fnStringToCss(iCorrection);
                }
                ...
                if (o.oScroll.sX === "") {
                    _fnLog(
                        o,
                        1,
                        "The table cannot fit into the current element which will cause column" +
            ...
            if (o.oScroll.sY === "") {
                 ...
                 */
                if (ie67) {
                    nScrollBody.style.height = _fnStringToCss(
                        o.nTable.offsetHeight + o.oScroll.iBarWidth,
                    );
                }
            }
            ...
            if (o.oScroll.sY !== "" && o.oScroll.bCollapse) {
                ...
                var iExtra =
                    o.oScroll.sX !== "" &&
                    o.nTable.offsetWidth > nScrollBody.offsetWidth
                        ? o.oScroll.iBarWidth
                        : 0;
                if (o.nTable.offsetHeight < nScrollBody.offsetHeight) {
                    nScrollBody.style.height = _fnStringToCss(
                        $(o.nTable).height() + iExtra,
                    );
                }
            }
            ...
            nScrollHeadInner.style.width = _fnStringToCss(
                iOuterWidth + o.oScroll.iBarWidth,
            );

            if (o.nTFoot !== null) {
                nScrollFootInner.style.width = _fnStringToCss(
                    o.nTable.offsetWidth + o.oScroll.iBarWidth,
                );
                nScrollFootTable.style.width = _fnStringToCss(
                    o.nTable.offsetWidth,
                );
            }
        ...
        function _fnAdjustColumnSizing(oSettings) {
            ...
            _fnCalculateColumnWidths(oSettings);
            for (var i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                oSettings.aoColumns[i].nTh.style.width =
                    oSettings.aoColumns[i].sWidth;
            }
        }
        ...
        function _fnFilterCustom(oSettings) {
            ...
            for (var i = 0, iLen = afnFilters.length; i < iLen; i++) {
                var iCorrector = 0;
                for (
                    var j = 0, jLen = oSettings.aiDisplay.length;
                    j < jLen;
                    j++
                ) {
                    ...
                    if (
                        !afnFilters[i](
                            oSettings,
                            _fnGetRowData(oSettings, iDisIndex, "filter"),
                            iDisIndex,
                        )
                    ) {
                ...
                if (
                    ...
                    for (i = 0; i < oSettings.aiDisplayMaster.length; i++) {
                        if (rpSearch.test(oSettings.asDataSearch[i])) {
                            oSettings.aiDisplay.push(
                                oSettings.aiDisplayMaster[i],
                            );
                        }
                    }
                } else {
        ...
        function _fnBuildSearchArray(oSettings, iMaster) {
            if (!oSettings.oFeatures.bServerSide) {
                ...
                var aArray =
                    typeof iMaster != "undefined" && iMaster == 1
        ...
        function _fnBuildSearchRow(oSettings, aData) {
            ...
            for (var j = 0, jLen = oSettings.aoColumns.length; j < jLen; j++) {
                if (oSettings.aoColumns[j].bSearchable) {
                    var sData = aData[j];
                    sSearch +=
                        _fnDataToSearch(sData, oSettings.aoColumns[j].sType) +
                        "  ";
                }
            }
        ...
        function _fnSort(oSettings, bApplyClasses) {
            ...
            if (
                ...
                if (oSettings.aaSortingFixed !== null) {
                    aaSort = oSettings.aaSortingFixed.concat(
                        oSettings.aaSorting,
                    );
                } else {
                ...
                for (i = 0; i < aaSort.length; i++) {
                    ...
                    var iVisColumn = _fnColumnIndexToVisible(
                        oSettings,
                        iColumn,
                    );
                    var sDataType = oSettings.aoColumns[iColumn].sSortDataType;
                    if (typeof _oExt.afnSortData[sDataType] != "undefined") {
                        var aData = _oExt.afnSortData[sDataType](
                            oSettings,
                            iColumn,
                            iVisColumn,
                        );
                 ...
                 */
                for (
                    i = 0, iLen = oSettings.aiDisplayMaster.length;
                    i < iLen;
                    i++
                ) {
            ...
            if (
                (typeof bApplyClasses == "undefined" || bApplyClasses) &&
                    ...
                    if (e.shiftKey) {
                        ...
                        for (var i = 0; i < oSettings.aaSorting.length; i++) {
                            if (oSettings.aaSorting[i][0] == iDataIndex) {
                                ...
                                if (
                                    typeof oSettings.aoColumns[iColumn]
                                        .asSorting[iNextSort] == "undefined"
                                ) {
                                    oSettings.aaSorting.splice(i, 1);
                                } else {
                                    oSettings.aaSorting[i][1] =
                                        oSettings.aoColumns[iColumn].asSorting[
                                            iNextSort
                                        ];
                        ...
                        if (
                            oSettings.aaSorting.length == 1 &&
                            oSettings.aaSorting[0][0] == iDataIndex
                        ) {
                            iColumn = oSettings.aaSorting[0][0];
                            iNextSort = oSettings.aaSorting[0][2] + 1;
                            if (
                                typeof oSettings.aoColumns[iColumn].asSorting[
                                    iNextSort
                                ] == "undefined"
                            ) {
                                iNextSort = 0;
        ...
        function _fnSortingClasses(oSettings) {
            ...
            for (i = 0; i < oSettings.aoColumns.length; i++) {
                if (oSettings.aoColumns[i].bSortable) {
                    ...
                    if (oSettings.bJUI) {
                        ...
                        if (iFound == -1) {
                            sSpanClass =
                                oSettings.aoColumns[i].sSortingClassJUI;
            ...
            if (oSettings.oFeatures.bSort && oSettings.oFeatures.bSortClasses) {
                ...
                if (oSettings.oFeatures.bDeferRender) {
                    $(nTds).removeClass(
                        sClass + "1 " + sClass + "2 " + sClass + "3",
                    );
                } else if (nTds.length >= iColumns) {
                    for (i = 0; i < iColumns; i++) {
                        if (nTds[i].className.indexOf(sClass + "1") != -1) {
                            for (
                                j = 0, jLen = nTds.length / iColumns;
                                j < jLen;
                                j++
                            ) {
                                nTds[iColumns * j + i].className = $.trim(
                                    nTds[iColumns * j + i].className.replace(
                                        sClass + "1",
                                        "",
                                    ),
                                );
                            ...
                            nTds[i].className.indexOf(sClass + "2") != -1
                        ) {
                            for (
                                j = 0, jLen = nTds.length / iColumns;
                                j < jLen;
                            ...
                            nTds[i].className.indexOf(sClass + "3") != -1
                        ) {
                            for (
                                j = 0, jLen = nTds.length / iColumns;
                                j < jLen;
        ...
        function _fnFeatureHtmlPaginate(oSettings) {
            ...
            nPaginate.className =
                oSettings.oClasses.sPaging + oSettings.sPaginationType;

            _oExt.oPagination[oSettings.sPaginationType].fnInit(
                oSettings,
                nPaginate,
                function (oSettings) {
                    _fnCalculateEnd(oSettings);
        ...
        function _fnUpdateInfo(oSettings) {
            ...
            if (
                ...
                sOut =
                    oSettings.oLanguage.sInfoEmpty +
            ...
            if (oSettings.oLanguage.fnInfoCallback !== null) {
                sOut = oSettings.oLanguage.fnInfoCallback(
                    oSettings,
                    iStart,
                    iEnd,
                    iMax,
        ...
        function _fnFeatureHtmlLength(oSettings) {
            ...
            if (
                oSettings.aLengthMenu.length == 2 &&
                typeof oSettings.aLengthMenu[0] == "object" &&
                typeof oSettings.aLengthMenu[1] == "object"
            ) {
                for (
                    i = 0, iLen = oSettings.aLengthMenu[0].length;
                    i < iLen;
                    i++
                ) {
                    sStdMenu +=
                        '<option value="' +
                        oSettings.aLengthMenu[0][i] +
                        '">' +
                ...
                for (
                    i = 0, iLen = oSettings.aLengthMenu.length;
                    i < iLen;
                    i++
                ) {
                    sStdMenu +=
            ...
            nLength.innerHTML =
                "<label>" +
                oSettings.oLanguage.sLengthMenu.replace("_MENU_", sStdMenu) +
                "</label>";
        ...
        function _fnFeatureHtmlProcessing(oSettings) {
            ...
            if (
                ...
                nProcessing.setAttribute(
                    "id",
                    oSettings.sTableId + "_processing",
                );
            }
        ...
        function _fnColumnIndexToVisible(oSettings, iMatch) {
            ...
            for (var i = 0; i < oSettings.aoColumns.length; i++) {
                ...
                if (i == iMatch) {
                    return oSettings.aoColumns[i].bVisible === true
                        ? iVisible
                        : null;
                }
            }
        ...
        function _fnCalculateColumnWidths(oSettings) {
            ...
            if (
                ...
                for (i = 0; i < iColums; i++) {
                    ...
                    if (
                        oColumn.bVisible &&
                        oColumn.sWidthOrig !== null &&
                        oColumn.sWidthOrig !== ""
                    ) {
                        nThs[i - iCorrector].style.width = _fnStringToCss(
                            oColumn.sWidthOrig,
                        );
                    ...
                    if (oSettings.aoColumns[i].bVisible) {
                        ...
                        if (nTd !== null) {
                            ...
                            if (oSettings.aoColumns[i].sContentPadding !== "") {
                                nTd.innerHTML +=
                                    oSettings.aoColumns[i].sContentPadding;
                            }
                            nTr.appendChild(nTd);
                        }
                    }
                ...
                if (
                    ...
                    nCalcTmp.style.width = _fnStringToCss(
                        oSettings.oScroll.sXInner,
                    );
                    ...
                    for (i = 0; i < oSettings.aoColumns.length; i++) {
                        if (oSettings.aoColumns[i].bVisible) {
                            if (oSettings.aoColumns[i].sWidthOrig === null) {
                                ...
                                iTotal +=
                                    parseInt(
                                        oSettings.aoColumns[i].sWidth.replace(
                                            "px",
                                            "",
                                        ),
                                        10,
                                    ) +
                                    ($(oNodes[iCorrector]).outerWidth() -
                                        $(oNodes[iCorrector]).width());
                            }
                            iCorrector++;
                        }
                    }
        ...
        function _fnGetTdNodes(oSettings, iIndividualRow) {
            ...
            for (iRow = iStart; iRow < iEnd; iRow++) {
                ...
                if (oData.nTr !== null) {
                    anTds = [];
                    for (
                        iColumn = 0, iColumns = oData.nTr.childNodes.length;
                        iColumn < iColumns;
                        iColumn++
                    ) {
                        sNodeName =
                            oData.nTr.childNodes[
                                iColumn
        ...
        function _fnClearTable(oSettings) {
            ...
            oSettings.aiDisplayMaster.splice(
                0,
                oSettings.aiDisplayMaster.length,
            );
            oSettings.aiDisplay.splice(0, oSettings.aiDisplay.length);
        ...
        function _fnSaveState(oSettings) {
            if (
                ...
                typeof oSettings.bDestroying != "undefined"
            ) {
                return;
            }
            ...
            sValue +=
                '"iStart":' +
                (oSettings.oScroll.bInfinite ? 0 : oSettings._iDisplayStart) +
                ",";
            sValue +=
                '"iEnd":' +
                (oSettings.oScroll.bInfinite
            ...
            sValue +=
                '"sFilter":"' +
                encodeURIComponent(oSettings.oPreviousSearch.sSearch) +
                '",';
            ...
            for (i = 0; i < oSettings.aoPreSearchCols.length; i++) {
                sValue +=
                    '["' +
                    encodeURIComponent(oSettings.aoPreSearchCols[i].sSearch) +
                    '",' +
                    !oSettings.aoPreSearchCols[i].bRegex +
                    "],";
            }
        ...
        function _fnLoadState(oSettings, oInit) {
            ...
            if (sData !== null && sData !== "") {
                ...
                try {
                    oData =
                        typeof JSON.parse == "function"
                            ? JSON.parse(sData.replace(/'/g, '"'))
                            : $.parseJSON(sData.replace(/'/g, '"'));
                } catch (e) {
                    return;
                }
                 ...
                 */
                for (
                    i = 0, iLen = oSettings.aoStateLoad.length;
                    i < iLen;
                    i++
                ) {
                ...
                oSettings.oPreviousSearch.sSearch = decodeURIComponent(
                    oData.sFilter,
                );
        ...
        function _fnCreateCookie(sName, sValue, iSecs, sBaseName, fnCallback) {
            ...
            var sNameFile =
                sName + "_" + aParts.pop().replace(/[\/:]/g, "").toLowerCase();
            ...
            if (iLength + 10 > 4096) {
                ...
                for (var i = 0, iLen = aCookies.length; i < iLen; i++) {
                    if (aCookies[i].indexOf(sBaseName) != -1) {
                        ...
                        if (
                            typeof oData.iCreate != "undefined" &&
                            oData.iCreate < iOldTime
                        ) {
        ...
        function _fnApplyToChildren(fn, an1, an2) {
            for (var i = 0, iLen = an1.length; i < iLen; i++) {
                for (
                    var j = 0, jLen = an1[i].childNodes.length;
                    j < jLen;
                    j++
                ) {
        ...
        return this.each(function () {
            ...
            for (i = 0, iLen = _aoSettings.length; i < iLen; i++) {
                if (_aoSettings[i].nTable == this) {
                    if (
                        typeof oInit == "undefined" ||
                        (typeof oInit.bRetrieve != "undefined" &&
                            oInit.bRetrieve === true)
                    ) {
                        return _aoSettings[i].oInstance;
                    } else if (
                        typeof oInit.bDestroy != "undefined" &&
                        oInit.bDestroy === true
                    ) {
                 ...
                 */
                if (
                    _aoSettings[i].sTableId !== "" &&
                    _aoSettings[i].sTableId == this.getAttribute("id")
                ) {
                    _aoSettings.splice(i, 1);
                    break;
                }
            ...
            if (this.nodeName.toLowerCase() != "table") {
                _fnLog(
                    oSettings,
                    0,
                    "Attempted to initialise DataTables on a node which is not a " +
                        "table: " +
                        this.nodeName,
                );
                return;
            ...
            if (typeof oInit != "undefined" && oInit !== null) {
                ...
                if (
                    typeof oInit.iDisplayStart != "undefined" &&
                    typeof oSettings.iInitDisplayStart == "undefined"
                ) {
                ...
                if (typeof oInit.oLanguage != "undefined") {
                    if (
                        typeof oInit.oLanguage.sUrl != "undefined" &&
                        oInit.oLanguage.sUrl !== ""
                    ) {
                        oSettings.oLanguage.sUrl = oInit.oLanguage.sUrl;
                        $.getJSON(
                            oSettings.oLanguage.sUrl,
                            null,
                            function (json) {
             ...
             */
            if (
                typeof oInit.asStripClasses == "undefined" &&
            ...
            for (
                i = 0, iLen = oSettings.asStripeClasses.length;
                i < iLen;
                i++
            ) {
                if (
                    anRows
                        .filter(":lt(2)")
                        .hasClass(oSettings.asStripeClasses[i])
                ) {
                    bStripeRemove = true;
                    break;
                }
            ...
            for (i = 0, iLen = aoColumnsInit.length; i < iLen; i++) {
                if (
                    typeof oInit.saved_aoColumns != "undefined" &&
                    oInit.saved_aoColumns.length == iLen
                ) {
                    if (aoColumnsInit[i] === null) {
                        aoColumnsInit[i] = {};
                    }
                    aoColumnsInit[i].bVisible =
                        oInit.saved_aoColumns[i].bVisible;
                }
                ...
                for (i = oInit.aoColumnDefs.length - 1; i >= 0; i--) {
                    ...
                    if (!$.isArray(aTargets)) {
                        _fnLog(
                            oSettings,
                            1,
                            "aTargets must be an array of targets, not a " +
                                typeof aTargets,
                        );
                    }
                    for (j = 0, jLen = aTargets.length; j < jLen; j++) {
                        if (
                            ...
                            _fnColumnOptions(
                                oSettings,
                                oSettings.aoColumns.length + aTargets[j],
                                oInit.aoColumnDefs[i],
                            );
                        } else if (typeof aTargets[j] == "string") {
                            for (
                                k = 0, kLen = oSettings.aoColumns.length;
                                k < kLen;
                                k++
                            ) {
                                if (
                                    aTargets[j] == "_all" ||
                                    $(oSettings.aoColumns[k].nTh).hasClass(
                                        aTargets[j],
                                    )
                                ) {
                                    _fnColumnOptions(
            ...
            for (i = 0, iLen = oSettings.aaSorting.length; i < iLen; i++) {
                ...
                if (
                    typeof oInit.aaSorting == "undefined" &&
