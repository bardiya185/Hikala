...
(function ($) {
            ...
            return this.each(function () {
                ...
                if ($.isFunction($(this).data("jGrowl.instance")[m])) {
                    $(this)
                        ...
                        [
                            m
                        ].apply($(this).data("jGrowl.instance"), $.makeArray(args).slice(1));
                } else {
    ...
    $.extend($.fn.jGrowl.prototype, {
        ...
        render: function (notification) {
            ...
            $(notification)
                .on("mouseover.jGrowl", function () {
                    $("div.jGrowl-notification", self.element).data(
                        "jGrowl.pause",
                        true,
                    );
                })
            ...
            if (
                $("div.jGrowl-notification:parent", self.element).length > 1 &&
                $("div.jGrowl-closer", self.element).length == 0 &&
                ...
                .each(function () {
                    if (
                        ...
                        $(this).data("jGrowl").created.getTime() +
                            parseInt($(this).data("jGrowl").life) <
                            new Date().getTime() &&
        ...
        startup: function (e) {
            ...
            if (
                navigator.userAgent.match(/MSIE ([2-6]\.)/) !== null &&
