...
(function ($) {
    var methods = {
        ...
        initSettingsEvents: function () {
            ...
            $this.on("change", function () {
                var $this = $(this);
                if (
                    typeof $this.treegrid("getSetting", "onChange") ===
                    "function"
                ) {
            ...
            $this.on("collapse", function () {
                var $this = $(this);
                if (
                    typeof $this.treegrid("getSetting", "onCollapse") ===
                    "function"
                ) {
            ...
            $this.on("expand", function () {
                var $this = $(this);
                if (
                    typeof $this.treegrid("getSetting", "onExpand") ===
                    "function"
                ) {
        ...
        initExpander: function () {
            ...
            var expander = $this
                .treegrid("getSetting", "getExpander")
                .apply(this);
            if (expander) {
                expander.remove();
            }
        ...
        initState: function () {
            ...
            if (
                ...
                if (
                    $this.treegrid("getSetting", "initialState") === "expanded"
                ) {
        ...
        isFirstInit: function () {
            ...
            if (tree.data("first_init") === undefined) {
                tree.data(
                    "first_init",
                    $.cookie(tree.treegrid("getSetting", "saveStateName")) ===
                        undefined,
                );
            }
        ...
        getParentNodeId: function () {
            return $(this)
                .treegrid("getSetting", "getParentNodeId")
                .apply(this);
        },
        /**
        ...
        collapse: function () {
            return $(this).each(function () {
                var $this = $(this);
                if (
                    !$this.treegrid("isLeaf") &&
                    !$this.treegrid("isCollapsed")
                ) {
    ...
    $.fn.treegrid = function (method) {
        if (methods[method]) {
            ...
            $.error(
                "Method with name " +
                    method +
                    " does not exists for jQuery.treegrid",
            );
        }
    };
    /**
    ...
    $.fn.treegrid.defaults = {
        ...
        getRootNodes: function (treegridContainer) {
            var result = $.grep(
                treegridContainer.find("tr"),
                function (element) {
                    var classNames = $(element).attr("class");
                    var templateClass = /treegrid-([A-Za-z0-9_-]+)/;
                    var templateParentClass =
