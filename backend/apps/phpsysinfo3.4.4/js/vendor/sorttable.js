            ...
            if (!headrow[i].className.match(/\bsorttable_nosort\b/)) {
                ...
                dean_addEvent(
                    ...
                    (sorttable.innerSortFunction = function (e) {
                        if (
                            this.className.search(/\bsorttable_sorted\b/) != -1
                        ) {
                            ...
                            sortrevind.id =
                                ...
                                $(this).parent().parent().parent()[0].id;
                        ...
                        for (var i = 0; i < theadrow.childNodes.length; i++) {
                            if (theadrow.childNodes[i].nodeType == 1) {
                                // an element
                                theadrow.childNodes[i].className =
                                    theadrow.childNodes[i].className.replace(
                                        "sorttable_sorted_reverse",
                                        "",
                                    );
                                theadrow.childNodes[i].className =
