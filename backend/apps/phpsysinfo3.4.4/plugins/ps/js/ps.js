...
function ps_buildTable(xml) {
    ...
    html +=
        '          <th style="width:15.25%;">' + genlang(5, "PS") + "</th>\n";
    html +=
        '          <th style="width:15.25%;">' + genlang(6, "PS") + "</th>\n";
    html += "        </tr>\n";
    html += "      </thead>\n";
    ...
    $("Plugins Plugin_PS Process", xml).each(function ps_getprocess(id) {
        ...
        name = $(this)
            ...
            .replace(
                /AAAAAAAA/g,
                "A<wbr>A<wbr>A<wbr>A<wbr>A<wbr>A<wbr>A<wbr>A<wbr>",
            )
            .replace(/,/g, ",<wbr>")
            .replace(/\s/g, " <wbr>")
            .replace(/\./g, ".<wbr>")
    ...
    if (memwas) {
        $(
            "#Plugin_PSTable td:nth-child(4),#Plugin_PSTable th:nth-child(4)",
        ).show();
    } else {
        $(
            "#Plugin_PSTable td:nth-child(4),#Plugin_PSTable th:nth-child(4)",
    ...
    if (cpuwas) {
        $(
            "#Plugin_PSTable td:nth-child(5),#Plugin_PSTable th:nth-child(5)",
        ).show();
    } else {
        $(
            "#Plugin_PSTable td:nth-child(5),#Plugin_PSTable th:nth-child(5)",
