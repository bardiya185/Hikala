function renderPlugin_ps(data) {
    var directives = {
        MemoryUsage: {
            html: function () {
                return (
                    '<div class="progress"><div class="progress-bar progress-bar-info" style="width:' +
                    this.MemoryUsage +
                    '%;"></div>' +
    ...
    if (data.Plugins.Plugin_PS !== undefined) {
        ...
        if (psitems.length > 0) {
            ...
            for (var i = 0; i < psitems.length; i++) {
                ...
                html +=
                    '<td><span class="treegrid-span" data-bind="Name"></span></td>';
                html += '<td><span data-bind="PID"></span></td>';
                html += '<td><span data-bind="PPID"></span></td>';
                html +=
                    '<td style="width:10%;"><span data-bind="MemoryUsage"></span></td>';
                html +=
                    '<td style="width:10%;"><span data-bind="CPUUsage"></span></td>';
                html += "</tr>";
            }
