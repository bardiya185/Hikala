...
$mysql_Limit = '5.7';
$mysql_Min = 'mysql'.str_replace('.','',$mysql_Limit);
$mariadb_Limit = '10.9';
$mariadb_Min = 'mariadb'.str_replace('.','',$mariadb_Limit);
...
foreach($wamp_versions as $key => $last_version) {
	...
	elseif($key == 'wamp_aestan') $key_txt = 'Tray Menu Manager';
