...
Type: item; Caption: "{$w_mariadbDoc}"; Action: run; FileName: "{$c_navigator}"; Parameters: "http://mariadb.com/kb/en/mariadb/documentation"; Glyph: 35
...
';
				$mariadbConfTextInfo .= 'Type: item; Caption: "'.$w_mysql_mode.'"; Action: TextKey; Glyph: 22
';
...
[maria_{$action}{$value}]
Action: service; Service: {$c_mariadbService}; ServiceAction: stop; Flags: waituntilterminated
Action: run; FileName: "{$c_phpExe}";Parameters: "changeMariadbParam.php {$quoted} {$action} {$param_value}{$param_third}";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
Action: multi; Actions: mariadb_refresh_start; Flags:appendsection
