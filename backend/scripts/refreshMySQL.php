...
Type: item; Caption: "{$w_mysqlDoc}"; Action: run; FileName: "{$c_navigator}"; Parameters: "http://dev.mysql.com/doc/index.html"; Glyph: 35
...
';
				$mysqlConfTextInfo .= 'Type: item; Caption: "'.$w_mysql_mode.'"; Action: TextKey; Glyph: 22
';
...
[{$action}{$value}]
Action: service; Service: {$c_mysqlService}; ServiceAction: stop; Flags: waituntilterminated
Action: run; FileName: "{$c_phpExe}";Parameters: "changeMysqlParam.php {$quoted} {$action} {$param_value}{$param_third}";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
Action: multi; Actions: mysql_refresh_start; Flags:appendsection
