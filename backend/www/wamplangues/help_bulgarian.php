...
$langues['fcgi_mode_link'] = 'Помощ за режим FCGI';
$langues['fcgi_not_loaded'] = 'PHP не може да се изпозлва в режим FCGI, защото модулът на Apache fcgid_module не е зареден.';
