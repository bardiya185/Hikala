...
const menuProfile = [
  ...
  { id: "orders", label: "سفارش ها", href: "/profile/orders/", icon: BsBag },
  { id: "lists", label: "لیست ها", href: "/profile/lists/", icon: GrFavorite },
  { id: "comments", label: "دیگاه و پرسش ها", href: "/profile/comments/", icon: FaRegComment },
  { id: "address", label: "ادرس ها", href: "/profile/addresses/", icon: SiGooglestreetview },
  { id: "cartGift", label: "کارت های هدیه", href: "/profile/gift-cards/", icon: CiGift },
  { id: "messages", label: "پیام ها", href: "/profile/notification/", icon: RiNotification3Line },
  { id: "time", label: "بازدید های اخیر", href: "/profile/user-history/", icon: MdAccessTime },
  { id: "user", label: "اطلاعات حساب کاربری", href: "/profile/personal-info/", icon: FaRegUser },
];
    ...
    <div className="max-w-[1270px] mx-auto my-10 px-4 flex flex-row gap-6 ">
      <div className="w-[331px] h-[937px] border border-solid border-neutral-400 rounded-lg flex flex-col h-full">
        ...
        `}
                      href={menu.href}
                    >
                      <Iconmenu className={`w-[22px] h-[20px] ${isActive ? "text-red-500" : "text-neutral-600"}`} />
