  ...
  return (
    <>
      <div className="max-w-[1270px] grid grid-cols-4 gap-3">
        ...
        <div className="w-full w-[300px] h-auto border border-solid border-neutral-400 rounded-[20px]">
          <div className="w-full h-fit bg-neutral-200 px-3 py-3 border border-solid rounded-[20px] ">
            <div className=" bg-white rounded-[20px] w-full h-full border border-solid border-neutral-200 px-4 py-4  ">
              <Image
                src="/icons/images.jfif"
                className="w-full object-cover rounded-[20px] bg-none "
                width={200}
                height={250}
                alt="e"
              />
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-neutral-400 text-[9px]">1200.00 $</span>
                </div>
              ...
              <p className="w-full h-fit mt-3 text-wrap">{ddd?.short_description}</p>
            </div>
          </div>
        </div>
          </div>
